package com.luis.todolist.task;
...
import com.luis.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request ){
        ...
        var task  = this.task_repository.save(taskModel);
        return ResponseEntity.status(HttpStatus.OK).body(task);
    }
    @GetMapping("/")
    public List<TaskModel> list(HttpServletRequest request){
        var idUser = request.getAttribute("idUser");
        var tasks = this.task_repository.findByIdUser((UUID) idUser);
        return tasks;
    }
    ...
    public ResponseEntity update(@RequestBody TaskModel taskModel,  HttpServletRequest request, @PathVariable UUID id){
        ...
        var task = this.task_repository.findById(id).orElse(null);
        ...
        var taskUpdated = this.task_repository.save(task);
